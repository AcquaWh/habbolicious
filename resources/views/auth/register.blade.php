...
<script src="https://www.google.com/recaptcha/api.js?render=6Lf45boUAAAAAOjH444_HTgPaJEXR2BgHF_Jqsil"></script>
@endsection
                                                ...
                                                <div class="col-md-6 offset-md-4">
                                                    <script>
                                                        grecaptcha.ready(function() {
                                                            grecaptcha.execute('6Lf45boUAAAAAOjH444_HTgPaJEXR2BgHF_Jqsil', {action: 'homepage'}).then(function(token) {
                                                            });
                                                        });
                                                    </script>
