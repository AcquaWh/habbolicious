...
@section('title','HabboLicious • Agregar noticias')
     ...
     <div class="row">
          <div class="col-md-12">
               ...
               <div class="m-portlet m-portlet--tab">
                    ...
                    <!--begin::Form-->
                    <form id="frmNoticias" class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data" method="POST" action="{{route('admin.noticias.store')}}">
                         @csrf
                         <div class="m-portlet__body">
                              ...
                              <div class="form-group m-form__group">
                                   ...
                                   <input class="form-control m-input" name="descripcion" type="text" maxlength="200" required>
                              </div>
                              <div class="form-group m-form__group">
