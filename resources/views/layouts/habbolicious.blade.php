                    ...
                    <div class="col-lg-6">
                         <div class="slider-noticias">
                              <div class="owl-carousel owl-theme">
                                   <div class="item" style="background-image:url(/img/portada/KwOrNTu.png);"><span class="titulo">Ponte el gorro de navidad!</span><br><br><span>Llego en otoño, nos esperan muchos eventos!</span></div>
                                   <div class="item" style="background-image:url(/img/portada/I1VAC1AB.png);"><span class="titulo">¡Vacantes disponibles, ahora!</span><br><br><span>¡ADENTRATE EN LA JUNGLA!</span></div>
                              </div>
                         </div>
                    </div>
                    <div class="col-lg-6">
                                        ...
                                        <div class="menu-ra row">
                                             <div class="col-lg-12">
                                                  ...
                                                  <div class="menu-radio">
                                                       <div class="dj"><i class="fas fa-heart"></i> 10 likes</div>
